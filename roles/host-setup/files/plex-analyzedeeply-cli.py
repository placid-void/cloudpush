...
conn = sqlite3.connect('/opt/appdata/plex/Library/Application Support/Plex Media Server/Plug-in Support/Databases/com.plexapp.plugins.library.db')
...
for row in items:
    ...
    os.system('LD_LIBRARY_PATH=/usr/lib/plexmediaserver \
               PLEX_MEDIA_SERVER_APPLICATION_SUPPORT_DIR=/opt/appdata/plex/Library/Application\ Support \
